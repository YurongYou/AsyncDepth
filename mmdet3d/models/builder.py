...
DTRANSFORM_NECK = Registry("dtransform_neck")

DTRANSFORM = Registry("dtransform")
...
def build_dtransform(cfg):
    return DTRANSFORM.build(cfg)

def build_dtransform_neck(cfg):
    return DTRANSFORM_NECK.build(cfg)
