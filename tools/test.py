...
from mmdet3d.apis import single_gpu_test, custom_multi_gpu_test
...
def main():
    ...
    torch.backends.cudnn.benchmark = True # pyright: ignore[reportGeneralTypeIssues]
    ...
    print("fp16 eval: ", cfg.get("fp16", False))
    ...
    if not distributed:
        ...
        if cfg.data.get("nonshuffler_sampler", None):
            print("using nonshuffler sampler")
